...
export const aggiungiCarrelloDettaglio = (carrelloDettaglioPayload) => {
  return async (dispatch) => {
    const baseEndPoint = `http://sicilyfresh.netlify.app/carrelloDettagli`;
...
export const findCarrelliDettagliByCarrelloId = (carrelloId) => {
  return async (dispatch) => {
    const baseEndPoint = `http://sicilyfresh.netlify.app/carrelloDettagli/${carrelloId}`;
    const token = localStorage.getItem("authToken");
    try {
      const resp = await fetch(baseEndPoint, {
        headers: {
...
export const deleteCarrelloDettaglio = (carrelloDettaglioId) => {
  return async (dispatch) => {
    ...
    const baseEndPoint = `http://sicilyfresh.netlify.app/carrelloDettagli/${carrelloDettaglioId}`;
    const token = localStorage.getItem("authToken");
...
export const getCarrelloDettaglioByRicetta = (ricettaId) => {
  return async (dispatch) => {
    const baseEndPoint = `http://sicilyfresh.netlify.app/carrelloDettagli/ricetta/${ricettaId}`;
    const token = localStorage.getItem("authToken");
    try {
      const resp = await fetch(baseEndPoint, {
        headers: {
...
export const changeStatoCarrelloDettaglio = (carrelloDettaglioId, nuovoStatoOrdine) => {
  return async (dispatch) => {
    const baseEndPoint = `http://sicilyfresh.netlify.app/carrelloDettagli/${carrelloDettaglioId}/stato`;
    const token = localStorage.getItem("authToken");
    try {
      const resp = await fetch(baseEndPoint, {
        method: "PATCH",
...
export const getCarrelloDettagliFornitore = (fornitoreId) => {
  return async (dispatch) => {
    const baseEndpoint = `http://sicilyfresh.netlify.app/carrelloDettagli/fornitore/${fornitoreId}`;
    const token = localStorage.getItem("authToken");
